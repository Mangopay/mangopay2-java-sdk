...
/**
 * ApiWalletsImpl test methods
 */
public class ApiWalletsImplTest extends BaseTest {
    ...
    public void getWallet() throws Exception {
        ...
        Wallet getWallet = this.api.getWallets().get(wallet.getId());
    ...
    public void updateWallet() throws Exception {
        ...
        Wallet saveWallet = this.api.getWallets().update(wallet);
    ...
    public void getWalletTransactions() throws Exception {
        ...
        List<Transaction> transactions = this.api.getWallets().getTransactions(wallet.getId(), pagination, filter);
    ...
    public void getWalletTransactionsAndSortByCreationDate() throws Exception {
        ...
        List<Transaction> transactions = this.api.getWallets().getTransactions(wallet.getId(), pagination, filter, sorting);
