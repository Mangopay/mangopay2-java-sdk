...
/**
 * ApiUsersImpl test methods
 */
public class ApiUsersImplTest extends BaseTest {
    ...
    public void createLegalFailsIfRequiredPropsNotProvided() throws Exception {
        ...
        try {
            ret = this.api.getUsers().create(user);
    ...
    public void getAllUsers() throws Exception {
        ...
        List<User> users = this.api.getUsers().getAll(null, sort);

        assertTrue(users.get(0).getCreationDate() > users.get(users.size() - 1).getCreationDate());

        sort = new Sorting();
        sort.addField("CreationDate", SortDirection.asc);
        users = this.api.getUsers().getAll(null, sort);
    ...
    public void getNatural() throws Exception {
        ...
        User user1 = this.api.getUsers().get(john.getId());
        UserNatural user2 = this.api.getUsers().getNatural(john.getId());
    ...
    public void getNaturalFailsForLegalUser() throws Exception {
        ...
        try {
            user = this.api.getUsers().getNatural(matrix.getId());
    ...
    public void getLegalFailsForNaturalUser() throws Exception {
        ...
        User user = null;
        try {
            user = this.api.getUsers().getLegal(john.getId());
    ...
    public void getLegal() throws Exception {
        ...
        User user1 = this.api.getUsers().get(matrix.getId());
        User user2 = this.api.getUsers().getLegal(matrix.getId());
    ...
    public void updateNatural() throws Exception {
        ...
        User userSaved = this.api.getUsers().update(john);
        User userFetched = this.api.getUsers().get(john.getId());
    ...
    public void updateLegal() throws Exception {
        ...
        User userSaved = this.api.getUsers().update(matrix);
        User userFetched = this.api.getUsers().get(matrix.getId());
    ...
    public void createBankAccountGB() {
        try {
            ...
            BankAccount createAccount = this.api.getUsers().createBankAccount(john.getId(), account);
    ...
    public void createBankAccountUS() {
        try {
            ...
            BankAccount createAccountSavings = this.api.getUsers().createBankAccount(john.getId(), account);
    ...
    public void updateBankAccount() throws Exception {
        try {
            ...
            BankAccount result = this.api.getUsers().updateBankAccount(john.getId(), disactivateBankAccount, account.getId());
    ...
    public void getBankAccount() throws Exception {
        ...
        BankAccount accountFetched = this.api.getUsers().getBankAccount(john.getId(), account.getId());
    ...
    public void getBankAccounts() throws Exception {
        ...
        List<BankAccount> list = this.api.getUsers().getBankAccounts(john.getId(), pagination, null);
    ...
    public void getBankAccountsAndSortByCreationDate() throws Exception {
        ...
        List<BankAccount> list = this.api.getUsers().getBankAccounts(john.getId(), pagination, sorting);
    ...
    public void updateKycDocument() throws Exception {
        ...
        KycDocument result = this.api.getUsers().updateKycDocument(john.getId(), kycDocument);
    ...
    public void getKycDocument() throws Exception {
        ...
        KycDocument result = this.api.getUsers().getKycDocument(john.getId(), kycDocument.getId());
    ...
    public void createKycPage() throws Exception {
        ...
        this.api.getUsers().createKycPage(john.getId(), kycDocument.getId(), filePath);

        kycDocument = this.getNewKycDocument();
        this.api.getUsers().createKycPage(john.getId(), kycDocument.getId(), Files.readAllBytes(Paths.get(filePath)));
    }
    ...
    public void getCards() throws Exception {
        ...
        List<Card> cardsBefore = this.api.getUsers().getCards(john.getId(), pagination, null);
        PayIn payIn = this.getNewPayInCardDirect();
        Card card = this.api.getCards().get(((PayInPaymentDetailsCard) payIn.getPaymentDetails()).getCardId());
        List<Card> cardsAfter = this.api.getUsers().getCards(john.getId(), pagination, null);
    ...
    public void getCardsAndSortByCreationDate() throws Exception {
        ...
        Sorting sorting = new Sorting();
        sorting.addField("CreationDate", SortDirection.desc);
        List<Card> cards = this.api.getUsers().getCards(john.getId(), pagination, sorting);
    ...
    public void getTransactions() throws Exception {
        ...
        List<Transaction> transactions = this.api.getUsers().getTransactions(john.getId(), pagination, new FilterTransactions(), null);
    ...
    public void getTransactionsAndSortByCreationDate() throws Exception {
        ...
        List<Transaction> transactions = this.api.getUsers().getTransactions(john.getId(), pagination, new FilterTransactions(), sorting);
    ...
    public void getKycDocuments() throws Exception {
        ...
        List<KycDocument> getKycDocuments = this.api.getUsers().getKycDocuments(user.getId(), pagination, null);
    ...
    public void getKycDocumentsAndSortByCreationDate() throws Exception {
        ...
        List<KycDocument> getKycDocuments = this.api.getUsers().getKycDocuments(user.getId(), pagination, sorting);
