...
/**
 * ApiMandatesImpl test methods.
 */
public class ApiMandatesImplTest extends BaseTest {
    ...
    public void getMandate() throws Exception {
        ...
        Mandate mandateCreated = this.api.getMandates().create(mandatePost);

        Mandate mandate = this.api.getMandates().get(mandateCreated.getId());
    ...
    public void cancelMandate() throws Exception {
        ...
        mandate = this.api.getMandates().get(mandate.getId());
        ...
        mandate = this.api.getMandates().cancel(mandate.getId());
    ...
    */
    ...
    public void getAllMandates() throws Exception {
        ...
        List<Mandate> mandates = this.api.getMandates().getAll(filters, null, null);
    ...
    public void getMandatesForUser() throws Exception {
        ...
        List<Mandate> mandates = this.api.getMandates().getForUser(user.getId(), new FilterMandates(), new Pagination(1, 1), null);
    ...
    public void getMandatesForBankAccount() throws Exception {
        ...
        List<Mandate> mandates = this.api.getMandates().getForBankAccount(user.getId(), mandatePost.getBankAccountId(), new FilterMandates(), new Pagination(1, 1), null);
