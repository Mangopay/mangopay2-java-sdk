 ...
 */
public class ApiReportsImplTest extends BaseTest {
    ...
    public void createReport() throws Exception {
        ...
        ReportRequest report = this.api.getReports().create(reportPost);
    ...
    public void getReport() throws Exception {
        ...
        ReportRequest getReport = this.api.getReports().get(report.getId());
    ...
    public void getReports() throws Exception {
        ...
        List<ReportRequest> list = this.api.getReports().getAll(pagination, null, sort);
        ...
        */
        ...
        list = this.api.getReports().getAll(pagination, filters, sort);
