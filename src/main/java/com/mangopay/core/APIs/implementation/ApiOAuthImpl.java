...
import com.mangopay.core.APIs.declaration.ApiOAuth;
 ...
 * API for OAuth.
 */
public class ApiOAuthImpl extends ApiBase implements ApiOAuth {

    /**
     * Instantiates new ApiOAuthImpl object.
     *
     * @param root Root/parent instance that holds the OAuthToken and Configuration instance.
     */
    public ApiOAuthImpl(MangoPayApi root) {
        super(root);
    }
    ...
    public OAuthToken createToken() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ApiOAuthImpl.class.getName()).log(Level.SEVERE, null, ex);
        }
        try {
