...
import com.mangopay.core.APIs.declaration.ApiCardRegistrations;
import com.mangopay.entities.CardRegistration;

/**
 * API for card registrations.
 */
public class ApiCardRegistrationsImpl extends ApiBase implements ApiCardRegistrations {
    
    /**
     * Instantiates new ApiCardRegistration object.
     * @param root Root/parent instance that holds the OAuthToken and Configuration instance
     */
    public ApiCardRegistrationsImpl(MangoPayApi root) { super(root); }
