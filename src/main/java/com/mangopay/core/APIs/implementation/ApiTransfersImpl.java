...
import com.mangopay.core.APIs.declaration.ApiTransfers;
import com.mangopay.entities.*;

/**
 * API for transfers.
 */
public class ApiTransfersImpl extends ApiBase implements ApiTransfers {

    /**
     * Instantiates new ApiTransfersImpl object.
     * @param root Root/parent instance that holds the OAuthToken and Configuration instance.
     */
    public ApiTransfersImpl(MangoPayApi root) { super(root); }
