 ...
 * API for wallets.
 */
public class ApiWalletsImpl extends ApiBase implements ApiWallets {
    
    /**
     * Instantiates new ApiWalletsImpl object.
     * @param root Root/parent instance that holds the OAuthToken and Configuration instance
     */
    public ApiWalletsImpl(MangoPayApi root) { super(root); }
